...
const Google = (props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill='url(#a)' d='M0 0h42v39H0z' />
      <Defs>
        <Pattern
          id='a'
